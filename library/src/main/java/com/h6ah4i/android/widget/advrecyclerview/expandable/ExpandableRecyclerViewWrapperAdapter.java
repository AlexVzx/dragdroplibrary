...
class ExpandableRecyclerViewWrapperAdapter
    ...
    @Override
    public void onItemDragStarted(@NonNull RecyclerView.ViewHolder holder,int position) {
        if (!(mExpandableItemAdapter instanceof ExpandableDraggableItemAdapter)) {
            return;
        }
    ...
    @Override
    public void onItemDragFinished(@NonNull RecyclerView.ViewHolder holder, int fromPosition, int toPosition, boolean result) {
