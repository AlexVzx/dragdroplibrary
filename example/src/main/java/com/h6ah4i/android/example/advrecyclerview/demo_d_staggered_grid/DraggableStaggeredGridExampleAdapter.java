...
class DraggableStaggeredGridExampleAdapter
    ...
    @Override
    public void onItemDragStarted(@NonNull BaseViewHolder holder, int position) {

    }

    @Override
    public void onItemDragFinished(@NonNull BaseViewHolder holder, int fromPosition, int toPosition, boolean result) {
